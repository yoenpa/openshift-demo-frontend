...
export class UsuarioService {
  ...
  urlGetUsuarios = 'http://http://demobackend-env.eba-phfuxkz4.us-east-1.elasticbeanstalk.com/rest/usuarios';
  urlGetUsuario = 'http://http://demobackend-env.eba-phfuxkz4.us-east-1.elasticbeanstalk.com/rest/usuario';
  urlGetLogin = 'http://http://demobackend-env.eba-phfuxkz4.us-east-1.elasticbeanstalk.com/rest/login';
